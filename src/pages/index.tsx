...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white flex flex-col items-center py-12 px-4">
      ...
      <input
        type="text"
        className="w-full max-w-lg p-3 rounded-md mb-3 bg-gray-900 text-white border border-gray-600"
      ...
      <div className="bg-gray-700 p-6 rounded-lg shadow-lg w-full max-w-lg">
        <input
          type="text"
          className="w-full p-3 rounded-md mb-3 bg-gray-900 text-white border border-gray-600"
          placeholder="Title"
          value={title}
        ...
        <div className="flex">
          <input
            type="text"
            className=" p-3 rounded-l-md bg-gray-900 text-white border border-gray-600"
          ...
          <button
            ...
            className="bg-blue-500 px-6 py-3 rounded-r-md hover:bg-blue-600 transition duration-200"
          >
            Add
          </button>
        </div>
      ...
      >
        {currentTodos?.length > 0 ? (
          currentTodos.map((todo, index) => (
            <div
              key={todo.id}
              className="bg-gray-800 p-4 rounded-lg flex justify-between items-center shadow-md hover:shadow-lg"
              data-id={todo.id}
            >
              {editingId === todo.id ? (
                <div className="flex w-full items-center space-x-4">
